...
zef.current_pattern = (zef.create_dipolar_pair_strength/zef.create_dipolar_pair_separation)*[zeros(size(evalin('base',['zef.' zef.current_sensors '_points']),1)-2,1) ; -1 ; 1];
