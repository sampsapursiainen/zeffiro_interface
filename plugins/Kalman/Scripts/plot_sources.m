...
file_full = fullfile(full_address, file_name);
set(gcf, 'color', 'w')
f2.Children.Children(end).FaceAlpha = 0.7;
f2.Children.Children(end-1).FaceAlpha = 0.7;
f2.Children.Children(end-2).FaceAlpha = 0.15;
