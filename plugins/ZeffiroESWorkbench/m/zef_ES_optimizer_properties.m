...
%% Autoresize
set(zef.h_ES_optimizer_properties,'Name',['ZEFFIRO Interface: ES optimizer properties ' num2str(length(findobj(groot,'-regexp','Name','ZEFFIRO Interface: ES optimizer properties*')))]);
