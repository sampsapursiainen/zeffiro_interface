if ismember(zef.ES_search_type,1)
    ...
    zef.ES_step_tolerance = str2double(zef.h_ES_parameter_table.Data{16,2});
    zef.ES_constraint_tolerance = str2double(zef.h_ES_parameter_table.Data{17,2});
...
if ismember(zef.ES_search_type,4)
 ...
 zef.ES_solver_tolerance = str2double(zef.h_ES_parameter_table.Data{14,2}); 
  zef.ES_max_n_iterations = str2double(zef.h_ES_parameter_table.Data{15,2});
 zef.ES_max_time = str2double(zef.h_ES_parameter_table.Data{16,2});
 zef.ES_display =  (zef.h_ES_parameter_table.Data{17,2});
