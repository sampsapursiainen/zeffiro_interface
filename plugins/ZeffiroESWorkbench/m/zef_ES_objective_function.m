...
vec = array2table({ES_y, ES_residual,ES_max,ES_nnz,ES_magnitude,ES_angle_error,ES_rela_norm,ES_rela_error,ES_off_field,ES_active_electrodes,ES_separation_angle,ES_search_method,ES_max_current_channel,ES_relative_weight_nnz,ES_cortex_thickness,ES_total_max_current,ES_source_density,ES_rela_source_amplitude}, 'VariableNames', ...
