...
if ismember(zef.ES_search_type,1)
    ...
    zef.h_ES_search_method.Items = zef.ES_search_method_list([1 3 4 5]);
zef.h_ES_search_method.ItemsData = [1 3 4 5];
...
if not(isequal(zef.ES_search_method,4))
   ...
   zef.h_ES_parameter_table.Data{18,1} = 'Step tolerance';
        ...
        zef.h_ES_parameter_table.Data{20,2} = num2str(zef.ES_max_time);
         zef.h_ES_parameter_table.Data{21,1} = 'Display';
        zef.h_ES_parameter_table.Data{21,2} = num2str(zef.ES_display);
else
        ...
        zef.h_ES_parameter_table.Data{3,1} = 'Relative weight of non-zero currents';
...
if ismember(zef.ES_search_type,2)
    ...
    zef.h_ES_search_method.Items = zef.ES_search_method_list([1 2 5]);
zef.h_ES_search_method.ItemsData = [1 2 5];
zef.h_ES_parameter_table.Data{1,1} = 'Alpha minimum (dB)';
        zef.h_ES_parameter_table.Data{1,2} = num2str(db(zef.ES_alpha));
        zef.h_ES_parameter_table.Data{2,1} = 'Alpha maximum (dB)';
        zef.h_ES_parameter_table.Data{2,2} = num2str(db(zef.ES_alpha_max));  
        ...
        zef.h_ES_parameter_table.Data{14,2} = num2str(zef.ES_roi_range);
         zef.h_ES_parameter_table.Data{15,1} = 'Solver tolerance';
        zef.h_ES_parameter_table.Data{15,2} = num2str(zef.ES_solver_tolerance);
         zef.h_ES_parameter_table.Data{16,1} = 'Display';
        zef.h_ES_parameter_table.Data{16,2} = num2str(zef.ES_display);
...
if ismember(zef.ES_search_type,4)
    ...
    zef.h_ES_search_method.Items = zef.ES_search_method_list([5]);
zef.h_ES_search_method.ItemsData = [5];
    zef.h_ES_parameter_table.Data{1,1} = 'Alpha minimum (dB)';
        zef.h_ES_parameter_table.Data{1,2} = num2str(db(zef.ES_alpha));
        zef.h_ES_parameter_table.Data{2,1} = 'Alpha maximum (dB)';
        zef.h_ES_parameter_table.Data{2,2} = num2str(db(zef.ES_alpha_max));  
   ...
   zef.h_ES_parameter_table.Data{16,1} = 'Absolute tolerance';
        zef.h_ES_parameter_table.Data{16,2} = num2str(zef.ES_absolute_tolerance);
         zef.h_ES_parameter_table.Data{17,1} = 'Relative tolerance';
        zef.h_ES_parameter_table.Data{17,2} = num2str(zef.ES_relative_tolerance);
...
if ismember(zef.ES_search_type,5)
    ...
    zef.h_ES_search_method.Items = zef.ES_search_method_list([1 5]);
zef.h_ES_search_method.ItemsData = [1 5];
    zef.h_ES_parameter_table.Data{1,1} = 'Alpha minimum (dB)';
        zef.h_ES_parameter_table.Data{1,2} = num2str(db(zef.ES_alpha));
        zef.h_ES_parameter_table.Data{2,1} = 'Alpha maximum (dB)';
        zef.h_ES_parameter_table.Data{2,2} = num2str(db(zef.ES_alpha_max));  
        ...
        zef.h_ES_parameter_table.Data{15,1} = 'Maximum number of iterations';
        zef.h_ES_parameter_table.Data{15,2} = num2str(zef.ES_max_n_iterations);
        zef.h_ES_parameter_table.Data{16,1} = 'Simplex';
        zef.h_ES_parameter_table.Data{16,2} = num2str(zef.ES_simplex);  
        zef.h_ES_parameter_table.Data{17,1} = 'Display';
        zef.h_ES_parameter_table.Data{17,2} = num2str(zef.ES_display); 

end

if ismember(zef.ES_search_type,6)
