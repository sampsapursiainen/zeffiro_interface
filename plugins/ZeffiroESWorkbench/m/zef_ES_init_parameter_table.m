...
if not(isequal(zef.ES_search_method,4))
    zef.h_ES_parameter_table.Data{1,1} = 'Alpha minimum (dB)';
        ...
        zef.h_ES_parameter_table.Data{11,1} = 'Acceptable threshold value';
   ...
   zef.h_ES_parameter_table.Data{17,1} = 'Step tolerance';
        zef.h_ES_parameter_table.Data{17,2} = num2str(zef.ES_step_tolerance);
         zef.h_ES_parameter_table.Data{18,1} = 'Constraint tolerance';
        zef.h_ES_parameter_table.Data{18,2} = num2str(zef.ES_constraint_tolerance);   
         zef.h_ES_parameter_table.Data{19,1} = 'Maximum time (s)';
        zef.h_ES_parameter_table.Data{19,2} = num2str(zef.ES_max_time);
         zef.h_ES_parameter_table.Data{20,1} = 'Display';
        zef.h_ES_parameter_table.Data{20,2} = num2str(zef.ES_display);
else
...
zef.h_ES_search_method.ItemsData = [1 5];
    zef.h_ES_parameter_table.Data{1,1} = 'Alpha minimum (dB)';
        ...
        zef.h_ES_parameter_table.Data{17,2} = num2str(zef.ES_max_time); 
         zef.h_ES_parameter_table.Data{18,1} = 'Display';
        zef.h_ES_parameter_table.Data{18,2} = num2str(zef.ES_display); 
