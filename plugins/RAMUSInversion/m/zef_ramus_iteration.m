...
zef.inv_sampling_frequency = zef.ramus_sampling_frequency;
zef.inv_low_cut_frequency = zef.ramus_low_cut_frequency;
zef.inv_high_cut_frequency = zef.ramus_high_cut_frequency;
zef.number_of_frames = zef.ramus_number_of_frames;
