...
ias_hyperprior = zef.inv_hyperprior;
snr_val = zef.inv_snr;
n_burn_in = zef.inv_n_burn_in;
...
number_of_frames = zef.inv_number_of_frames;
...
reconstruction_information.n_burn_in = zef.inv_n_burn_in;
reconstruction_information.n_sample_size = zef.inv_sample_size;
...
reconstruction_information.number_of_frames = zef.inv_number_of_frames;
...
reconstruction_information.ias_hyperprior = zef.inv_hyperprior;
...
if zef.inv_hyperprior == 1
    [beta, theta0] = zef_find_ig_hyperprior(snr_val-pm_val,zef.inv_hyperprior_tail_length_db,L,size(L,2),zef.inv_normalize_data,balance_spatially,zef.inv_hyperprior_weight);
elseif zef.inv_hyperprior == 2
    [beta, theta0] = zef_find_g_hyperprior(snr_val-pm_val,zef.inv_hyperprior_tail_length_db,L,size(L,2),zef.inv_normalize_data,balance_spatially,zef.inv_hyperprior_weight);
end
