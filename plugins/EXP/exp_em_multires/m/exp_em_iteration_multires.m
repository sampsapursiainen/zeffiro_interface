...
snr_val = evalin('base','zef.exp_em_multires_snr');
...
if size_f > 1  
if evalin('base','zef.exp_em_multires_time_2') >=0 && evalin('base','zef.exp_em_multires_time_1') >= 0 && 1 + sampling_freq*evalin('base','zef.exp_em_multires_time_1') <= size_f
f = f_data(:, max(1, 1 + floor(sampling_freq*evalin('base','zef.exp_em_multires_time_1')+sampling_freq*(f_ind - 1)*evalin('base','zef.exp_em_multires_time_3'))) : min(size_f, 1 + floor(sampling_freq*(evalin('base','zef.exp_em_multires_time_1') + evalin('base','zef.exp_em_multires_time_2'))+sampling_freq*(f_ind - 1)*evalin('base','zef.exp_em_multires_time_3'))));
end
end
