...
'String','Hyperprior:',...
'Style','text',...
'Position',[0.0348311365552745 0.926237026570902 0.475482378930655 0.0446621923937361],...
'Children',[],...
'Tag','text2',...
'UserData',[],...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.572410094823888 0.916666556772244 0.408063235649443 0.0497664429530199],...
...
'FontUnits','normalized',...
'String','Start',...
'Position',[0.799025551529964 0.024851709260336 0.172851888067813 0.0705351159964065],...
'Callback','zef_update_ias; zef.reconstruction = ias_iteration([]);',...
'Children',[],...
'CreateFcn', '' ,...
'Tag','pushbutton12',...
...
'FontUnits','normalized',...
'String','Close',...
'Position',[0.431161276924106 0.024851709260336 0.172851888067813 0.0705351159964065],...
...
'FontUnits','normalized',...
'String','Apply',...
'Position',[0.615128232666164 0.0241589330529574 0.172851888067813 0.0705351159964065],...
