...
if iscell(zef.measurements)
    set(zef.h_iasroi_data_segment,'enable','on');
end
if not(iscell(zef.measurements))
    set(zef.h_iasroi_data_segment,'enable','off'); 
end
end
...
zef.h_iasroi_roi_threshold; zef.h_iasroi_hyperprior; 
    ...
    zef.h_iasroi_number_of_frames; zef.h_iasroi_time_3; zef.h_iasroi_data_segment ; zef.h_iasroi_cancel ; 
