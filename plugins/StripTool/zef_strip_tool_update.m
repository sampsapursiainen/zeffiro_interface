...
color_str_aux = 'orange';
elseif isequal(cell_aux{i}.strip_status,'Active')
    color_str_aux = 'green';
elseif isequal(cell_aux{i}.strip_status,'Inactive')
    color_str_aux = 'blue';
end

string_aux = ['<HTML><BODY>' 'ID: ' num2str(cell_aux{i}.strip_id) ', Tag: ' cell_aux{i}.strip_tag ', Model: ' zef.strip_tool.h_strip_model.String{cell_aux{i}.strip_model} ', Status: <SPAN style="color:' color_str_aux '">' cell_aux{i}.strip_status '</SPAN> </BODY></HTML>']; 
