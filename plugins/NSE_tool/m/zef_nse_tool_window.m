...
zef.nse_field.h_pulse_frequency= zef_data.h_pulse_frequency;
zef.nse_field.h_pulse_frequency.ValueChangedFcn = 'zef = zef_nse_tool_update(zef);';
...
zef.nse_field.h_vessel_resistance = zef_data.h_vessel_resistance;
zef.nse_field.h_vessel_resistance.ValueChangedFcn = 'zef = zef_nse_tool_update(zef);';
...
zef.nse_field.h_pulse_frequency.Value = zef.nse_field.pulse_frequency;
...
zef.nse_field.h_vessel_resistance.Value = zef.nse_field.vessel_resistance;
...
zef.nse_field.h_conductivity_model.Items = {'Arithmetic','Exponential'};
...
zef.nse_field.h_solve_system.ButtonPushedFcn = 'zef = zef_nse_tool_update(zef); zef.nse_field = zef_nse_poisson(zef.nse_field,zef.nodes,zef.tetra,zef.domain_labels,zef.mvd_length,zef.mvd_volume);';
