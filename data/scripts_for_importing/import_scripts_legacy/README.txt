This folder contains a zef file which allows one to import a surface 
segmentation consisting of a set of ASCII files to the Zeffiro Interface 
(ZI), Copyright (c) Sampsa Pursiainen, 2018. For importing, this
...
Each compartment-specific parameter can be imported only once. In case
