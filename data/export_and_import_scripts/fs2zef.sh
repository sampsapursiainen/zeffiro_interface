...
mris_convert $SUBJECT_DIR/$SUBJECT/surf/outer_outer_skin_surface $OUT_DIR/outer_skin.asc
mris_convert $SUBJECT_DIR/$SUBJECT/surf/outer_outer_skull_surface $OUT_DIR/outer_skull.asc
mris_convert $SUBJECT_DIR/$SUBJECT/surf/outer_inner_skull_surface $OUT_DIR/inner_skull.asc
...
mri_annotation2label  --subject $SUBJECT --annotation aparc.a2009s --hemi lh --ctab aparc.annot.a2009s --outdir $OUT_DIR/lh.aparc_76
mri_annotation2label  --subject $SUBJECT --annotation aparc.a2009s --hemi rh --ctab aparc.annot.a2009s --outdir $OUT_DIR/rh.aparc_76
mri_annotation2label  --subject $SUBJECT --annotation aparc --hemi lh --ctab aparc.annot --outdir $OUT_DIR/lh.aparc_36
mri_annotation2label  --subject $SUBJECT --annotation aparc --hemi rh --ctab aparc.annot --outdir $OUT_DIR/rh.aparc_36
