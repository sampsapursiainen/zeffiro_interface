function self = create_finite_element_mesh( ...
    ...
    self = self ...
        ...
        .build_initial_mesh() ...
        .label_mesh("initial") ...
        .refine_surface("mesh generation", n_of_surface_refinements) ...
        .refine_volume("mesh generation", n_of_volume_refinements) ...
        .refine_volume_adaptively("mesh generation", n_of_adaptive_volume_refinements) ...
