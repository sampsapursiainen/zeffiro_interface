...
%
    ...
    methods
        ...
        %
            ...
            out = zefCore.StiffnessMatrix.fromDouble ( dl + dr ) ;
        ...
        %
            ...
            out = zefCore.StiffnessMatrix.fromDouble ( - self.data ) ;
        ...
        %
            ...
            newArgs = cell ( N, 1 ) ;
            for ii = 1 : N
                if isa ( varargin {ii}, 'zefCore.StiffnessMatrix' )
                    newArgs {ii} = varargin{ii}.data ;
                else
                    newArgs {ii} = varargin{ii} ;
                end
            end
            out = zefCore.StiffnessMatrix.fromDouble ( cat ( dim, newArgs {:} ) ) ;
    ...
    methods (Static)
        ...
        %
            ...
            self = zefCore.StiffnessMatrix ( data=array ) ;
        ...
        %
            ...
            if nargin > 1
                ...
                self = zefCore.StiffnessMatrix ( data=double.empty (sizevec) ) ;
            elseif nargin == 1
                self = zefCore.StiffnessMatrix ( data=double.empty (sizevec) ) ;
            else
                self = zefCore.StiffnessMatrix ( data=double.empty ) ;
            end
