...
%
    ...
    properties
        ...
        % Most tested ones are zefCore.ZefSourceModel.{Whitney,Hdiv}, so one
        % should probably stick to these for now.
        %
        source_model (1,1) zefCore.ZefSourceModel = zefCore.ZefSourceModel.Hdiv
        %
    ...
    methods
        ...
        %
            ...
            arguments
                ...
                kwargs.source_model = zefCore.ZefSourceModel.Hdiv
