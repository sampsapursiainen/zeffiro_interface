...
%
% - kwargs.aseg_stats_file = recon_all_output_folder / stats / aseg.stats
%
%   A file that contains the IDs, compartment names and other statistics related to
%   subcortical compartments found in the aseg.mgz file generated by recon-all.
%
% - kwargs.compartmentNameColumnName (1,1) = "StructName"
%
%   The name of the compartment name column in an aseg.stats file corresponding
%   to an aseg.mgz file.
%
% - kwargs.compartmentIdColumnName = "SegId"
%
%   The name of the compartment ID column in an aseg.stats file corresponding
%   to an aseg.mgz file.
%
% Outputs:
%
...
%
    ...
    arguments
        ...
        kwargs.aseg_stats_file (1,1) string = fullfile(recon_all_output_folder, "stats", "aseg.stats" )

        kwargs.compartmentNameColumnName (1,1) string = "StructName"

        kwargs.compartmentIdColumnName (1,1) string = "SegId"
    ...
    asegCompartmentTable = utilities.fs2zef.readAsegStatsFile(kwargs.aseg_stats_file,compartmentNameColumnTitle=kwargs.compartmentNameColumnName) ;

    compartmentNames = asegCompartmentTable.(kwargs.compartmentNameColumnName) ;
    ...
    for ii = 1 : compartmentN
        ...
        compartmentName = compartmentNames(ii);

        out_path = fullfile(segmentation_output_folder, compartmentName) + ".asc" ;

        cmd = mri_mc + " " + mri_input_path + " " + compartmentID + " " + out_path;
