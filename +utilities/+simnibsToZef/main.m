...
% a tissue listing file generated by the charm pipeline of SimNIBS version 4.5.0.
% Also stores these on disk if asked to do so via a non-empty output folder path.
%
% Inputs:
%
