%This is Brainstorm-Zeffiro plugin which provides a pipeline between the 
%functionalities of these two Matlab-based brain modelling toolboxes.
%Most important parameter values and their initial values are listed below.
...
%
% zef_bst.surface_mesh_types = cell(0);
%   
%                               This parameter (cell array) determines the 
%                               surface type of each mesh mesh file in 
%                               surface_mesh_files. The type can be
%                               'Scalp','OuterSkull','InnerSkull','Cortex', or 'Other'.
%
...
%
%zef_bst.distance_smoothing_on = 0; 
%
%                               This parameter (logical 1 or 0) determines
%                               whether an exponential distance function is 
