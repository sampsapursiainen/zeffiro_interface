function out_cell = zef_bst_default_fem_mesh_create(run_type,settings_file_name,project_file_name,zef_bst)
...
zef = utilities.brainstorm2zef.m.zef_bst_create_project(settings_file_name,[],zef_bst,zef);
