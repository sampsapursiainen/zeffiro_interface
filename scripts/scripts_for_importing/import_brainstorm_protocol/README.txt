This folder contains an example on importing a currently open Brainstorm protocol into Zeffiro Interface. The file (.ZEF) can be imported in ZI. Each line describes a single import item. The parameter name and value occur as comma-separated pairs described below.  
