...
matlab -nodisplay -nosplash -nodesktop -r "dir_name = fullfile('$SUBJECT_DIR', '$SUBJECT'); [vertices,label,colortable] = read_annotation([dir_name filesep 'label' filesep 'lh.aparc.a2009s.annot']); save([dir_name filesep 'color_table_lh_76.mat'],'colortable','label','vertices'); [vertices,label,colortable] = read_annotation([dir_name filesep 'label' filesep 'rh.aparc.a2009s.annot']); save([dir_name filesep 'color_table_rh_76.mat'],'colortable','label','vertices'); [vertices,label,colortable] = read_annotation([dir_name filesep 'label' filesep 'lh.aparc.annot']); save([dir_name filesep 'color_table_lh_36.mat'],'colortable','label','vertices'); [vertices,label,colortable] = read_annotation([dir_name filesep 'label' filesep 'rh.aparc.annot']); save([dir_name filesep 'color_table_rh_36.mat'],'colortable','label','vertices'); exit;";
...
matlab -nodisplay -nosplash -nodesktop -r "dir_name = '$OUT_DIR';a = dlmread(fullfile(dir_name, 'lh_labels_76.asc'),' ',2,0); a = a(:,[1,3,5,7]); save([dir_name filesep 'lh_points_76.dat'],'-ascii','a'); a = dlmread(fullfile(dir_name, 'rh_labels_76.asc'),' ',2,0); a = a(:,[1,3,5,7]); save([dir_name filesep 'rh_points_76.dat'],'-ascii','a'); a = dlmread(fullfile(dir_name, 'lh_labels_36.asc'),' ',2,0); a = a(:,[1,3,5,7]); save([dir_name filesep 'lh_points_36.dat'],'-ascii','a'); a = dlmread(fullfile(dir_name, 'rh_labels_36.asc'),' ',2,0); a = a(:,[1,3,5,7]); save([dir_name filesep 'rh_points_36.dat'],'-ascii','a'); quit";
