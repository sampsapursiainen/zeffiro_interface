function L = eegLeadField ( nodes, tetra, electrodes, triA, eA, e2nI, t2nI, A, params )
%
...
%
    ...
    if isreal ( electrodes.impedances )
        ...
        realC = core.voltageMat ( imag ( impedances ), impedances ) ;
    end
    ...
    [realT, realSC, A] = core.transferMatrix( ...
        A , ...
        B , ...
        C , ...
        nN , ...
    ...
    if ~ isreal ( electrodes.impedances )
        ...
        [imagT, imagSC, A] = core.transferMatrix( ...
            A , ...
            B , ...
            C , ...
            nN , ...
