...
\coderubric{zef.nodes} The nodes of the curently existing finite element mesh.
This will be constructed alogside with \code{zef.tetra} when the mesh
generation routine is run.

\coderubric{zef.tetra} The tetrahedra in the current finite element mesh. This
will be constructed alogside with \code{zef.nodes} when the mesh generation
routine is run.
