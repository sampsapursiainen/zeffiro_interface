...
Interface's mesh generation routine. The names, sizes, types, validators and
...
\zeffield{mesh\_smoothing\_on}{1,1}{logical}{}{A switch for determining
whether mesh smoothing will be attempted during mesh generation.}
...
\zeffield{refinement\_surface\_compartments}{1,:}{int32}{}{Has something to
do with which compartment surfaces will be refined during mesh refinement.
What exactly, though, Santtu has no idea. TODO.}
