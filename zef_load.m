...
if (isfield(zef_data,'d5_sources'));
zef.d5_sources = zef_data.d5_sources; 
end;
if (isfield(zef_data,'d6_sources'));
zef.d6_sources = zef_data.d6_sources; 
end;
if (isfield(zef_data,'d7_sources'));
zef.d7_sources = zef_data.d7_sources; 
end;
if (isfield(zef_data,'d8_sources'));
zef.d8_sources = zef_data.d8_sources; 
end;
if (isfield(zef_data,'d9_sources'));
zef.d9_sources = zef_data.d9_sources; 
end;
if (isfield(zef_data,'d10_sources'));
zef.d10_sources = zef_data.d10_sources; 
end;
if (isfield(zef_data,'d11_sources'));
zef.d11_sources = zef_data.d11_sources; 
end;
if (isfield(zef_data,'d12_sources'));
zef.d12_sources = zef_data.d12_sources; 
end;
