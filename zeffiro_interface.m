...
zef_init;
zef.h_zeffiro_window_1 = open('zeffiro_interface_1.fig');
zef_init;
zef.aux_handle_vec = [...
zef.h_wm_sources;
zef.h_d1_sources;
...
zef.h_zeffiro_window_2 = open('zeffiro_interface_2.fig');
zef.h_zeffiro = zef.h_zeffiro_window_2;
zef.h_zeffiro_window_3 = open('zeffiro_interface_3.fig');
...
zef.o_h = findall(zef.h_zeffiro_window_2);
