classdef zef_segmentation_tool_app_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.h_axes2.Position = [349 133 74 22];
            ...
            app.h_compartment_table.Position = [10 159 563 351];
            ...
            app.h_sensors_table.Position = [593 378 321 132];
            ...
            app.h_transform_table.Position = [593 159 150 185];
            ...
            app.CompartmentsLabel.Position = [11 522 89 22];
            ...
            app.h_parameters_table.Position = [757 159 157 185];
            ...
            app.ProjecttagEditFieldLabel.Position = [432 523 72 22];
