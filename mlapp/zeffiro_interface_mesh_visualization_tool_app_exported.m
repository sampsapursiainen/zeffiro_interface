classdef zeffiro_interface_mesh_visualization_tool_app_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.h_mesh_visualization_tool.Position = [1000 700 348 404];
            ...
            app.h_pushbutton31.Position = [12 365 158 30];
            ...
            app.h_pushbutton20.Position = [181 365 156 30];
            ...
            app.h_pushbutton22.Position = [14 329 156 30];
            ...
            app.h_visualization_type.Position = [44 108 73 22];
            ...
            app.h_layer_transparency.Position = [311 57 26 22];
            ...
            app.h_reconstruction_type.Position = [42 158 75 22];
            ...
            app.RotationspeeddegsEditFieldLabel.Position = [13 183 86 22];
            ...
            app.RotationspeeddegsLabel.Position = [237 183 107 22];
            ...
            app.h_inv_scale.Position = [42 12 75 22];
            ...
            app.h_inv_colormap.Position = [155 12 75 22];
            ...
            app.h_cp_mode.Position = [42 57 75 22];
            ...
            app.h_brain_transparency.Position = [278 57 26 22];
            ...
            app.h_inv_dynamic_range.Position = [285 12 52 22];
            ...
            app.TransparencyrecsurfLabel.Position = [233 83 109 22];
            ...
            app.PlotthresholdLabel.Position = [237 35 100 22];
            ...
            app.DistributionmodeLabel.Position = [123 183 104 22];
            ...
            app.h_streamline_draw.Position = [14 210 85 22];
