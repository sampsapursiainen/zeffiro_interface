classdef zeffiro_interface_mesh_visualization_tool_app_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.h_mesh_visualization_tool.Position = [1000 700 353 701];
            ...
            app.h_pushbutton31.Position = [12 662 158 30];
            ...
            app.h_pushbutton20.Position = [181 662 156 30];
            ...
            app.h_pushbutton22.Position = [14 626 156 30];
            ...
            app.h_visualization_type.Position = [44 405 73 22];
            ...
            app.h_layer_transparency.Position = [311 354 26 22];
            ...
            app.h_reconstruction_type.Position = [42 455 75 22];
            ...
            app.RotationspeeddegsEditFieldLabel.Position = [13 480 86 22];
            ...
            app.RotationspeeddegsLabel.Position = [237 480 107 22];
            ...
            app.h_inv_scale.Position = [42 309 75 22];
            ...
            app.h_inv_colormap.Position = [155 309 75 22];
            ...
            app.h_cp_mode.Position = [42 354 75 22];
            ...
            app.h_brain_transparency.Position = [278 354 26 22];
            ...
            app.h_inv_dynamic_range.Position = [285 309 52 22];
            ...
            app.TransparencyrecsurfLabel.Position = [233 380 109 22];
            ...
            app.PlotthresholdLabel.Position = [237 332 100 22];
            ...
            app.DistributionmodeLabel.Position = [123 480 104 22];
            ...
            app.h_streamline_draw.Position = [14 507 85 22];
            ...
            app.ParameterListBoxLabel.Position = [14 280 64 22];
            ...
            app.h_mesh_visualization_parameter_list.Position = [14 179 323 99];

            % Create GraphLabel
            app.GraphLabel = uilabel(app.h_mesh_visualization_tool);
            app.GraphLabel.Position = [14 153 42 22];
            ...
            app.h_mesh_visualization_graph_list.Position = [14 52 323 99];

            % Create h_plot_graph
            app.h_plot_graph = uibutton(app.h_mesh_visualization_tool, 'push');
            app.h_plot_graph.Position = [181 11 156 30];
