classdef zeffiro_interface_mesh_tool_app_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        h_plot_condition              matlab.ui.control.Button
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.h_field_downsampling.Position = [16 317 165 39];
            ...
            app.h_surface_downsampling.Position = [190 317 165 39];
            ...
            app.h_source_interpolation_on.Position = [20 195 161 22];
            ...
            app.h_downsample_surfaces.Position = [192 195 163 22];

            % Create SurfacetrianglesmaxLabel
            app.SurfacetrianglesmaxLabel = uilabel(app.h_mesh_tool);
            app.SurfacetrianglesmaxLabel.Position = [20 90 102 22];
            ...
            app.CuttingplanecoeffEditFieldLabel_4.Position = [131 141 100 22];
            ...
            app.CuttingplanecoeffEditFieldLabel_5.Position = [245 141 87 22];
            ...
            app.CuttingplanecoeffEditFieldLabel_6.Position = [20 141 85 22];
            ...
            app.CuttingplanecoeffEditFieldLabel_7.Position = [131 90 89 22];
            ...
            app.CuttingplanecoeffEditFieldLabel_9.Position = [132 37 99 22];
            ...
            app.h_inflate_strength.Position = [186 12 50 22];

            % Create h_inflate_n_iterations
            app.h_inflate_n_iterations = uieditfield(app.h_mesh_tool, 'numeric');
            app.h_inflate_n_iterations.Position = [75 12 50 22];

            % Create h_plot_condition
            app.h_plot_condition = uibutton(app.h_mesh_tool, 'push');
            app.h_plot_condition.Position = [192 225 164 39];
            app.h_plot_condition.Text = {'Plot FEM mesh'; 'condition'};
            ...
            app.h_forward_simulation_table.Position = [366 171 338 231];

            % Create h_save_forward_simulation_profile
            app.h_save_forward_simulation_profile = uibutton(app.h_mesh_tool, 'push');
            app.h_save_forward_simulation_profile.Position = [366 14 105 39];
            ...
            app.h_forward_simulation_script.Position = [366 62 338 101];
            ...
            app.h_forward_simulation_update_from_profile.Position = [483 14 105 39];
