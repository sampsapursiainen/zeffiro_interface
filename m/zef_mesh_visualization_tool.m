...
zef.h_mesh_visualization_tool.Position = [zef.h_zeffiro_window_main.Position(1) + 1.75*0.505*zef.h_zeffiro_window_main.Position(3), ...
                          zef.h_zeffiro_window_main.Position(2),...
                          0.5*0.505*zef.h_zeffiro_window_main.Position(3),...
                          zef.h_zeffiro_window_main.Position(4)];
                          
else

zef.h_mesh_visualization_tool.Position = [zef.h_zeffiro_window_main.Position(1) + 1.75*zef.h_zeffiro_window_main.Position(3), ...
                          zef.h_zeffiro_window_main.Position(2),...
                          0.5*zef.h_zeffiro_window_main.Position(3),...
                          zef.h_zeffiro_window_main.Position(4)]; 
