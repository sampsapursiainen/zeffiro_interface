...
evalin('base','zef.h_update_zoom.Value = zef.cam_va;');
...
evalin('base','zef.h_update_transparency_cones.Value = zef.update_transparency_cones;');
evalin('base','zef.h_update_transparency_additional.Value = zef.update_transparency_additional;');
evalin('base','zef.h_update_brightness.Value = zef.update_brightness;');
evalin('base','zef.h_update_contrast.Value = zef.update_contrast;');
...
evalin('base','zef.update_brightness = zef_update_brightness;');
evalin('base','zef.update_contrast = zef_update_contrast;');
evalin('base','zef.update_transparency_reconstruction = zef_update_transparency_reconstruction(zef.h_axes1,zef.h_update_transparency_reconstruction.Value,0);');
evalin('base','zef.update_transparency_surface = zef_update_transparency_surface(zef.h_axes1,zef.h_update_transparency_surface.Value,0);');
evalin('base','zef.update_transparency_sensor = zef_update_transparency_sensor(zef.h_axes1,zef.h_update_transparency_sensor.Value,0);');
evalin('base','zef.update_transparency_additional = zef_update_transparency_additional(zef.h_axes1,zef.h_update_transparency_additional.Value,0);');
evalin('base','zef.update_transparency_cones = zef_update_transparency_cones(zef.h_axes1,zef.h_update_transparency_cones.Value,0);');
