...
'Callback','[zef.parcellation_interp_ind] = zef_parcellation_interpolation([]); zef_update_parcellation; set(zef.h_parcellation_interpolation,''foregroundcolor'',[0 0 0]);',...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', '' ,...
'DeleteFcn',blanks(0),...
