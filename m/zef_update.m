...
if not(isempty(zef.aux_field_1))
for zef_i = 1 : size(zef.aux_field_1,1)
if not(isnan(zef.aux_field_1{zef_i,1})) ||  zef.aux_field_1{zef_i,3}
...
zef.sensor_tags = zef.sensor_tags(zef.aux_field_2);
    ...
    zef.aux_field_1{zef_i,3} = evalin('base',['zef.' zef.sensor_tags{zef_i} '_on']);
    zef.aux_field_1{zef_i,4} = evalin('base',['zef.' zef.sensor_tags{zef_i} '_visible']);
    zef.aux_field_1{zef_i,5} = evalin('base',['not(isempty(zef.' zef.sensor_tags{zef_i} '_points))']);
    zef.aux_field_1{zef_i,6} = evalin('base',['not(isempty(zef.' zef.sensor_tags{zef_i} '_directions))']);
    end
