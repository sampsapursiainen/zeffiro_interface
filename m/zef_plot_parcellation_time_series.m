...
set(evalin('base','zef.h_axes1'),'xticklabel',[]);
set(evalin('base','zef.h_axes1'),'ticklength',[0 0]);
x_labels = text(x_vals-0.5,1.02*size(y_vals,1)*ones(size(x_vals)),parcellation_list(selected_list),'Parent',evalin('base','zef.h_axes1'));
set(x_labels,'HorizontalAlignment','right','VerticalAlignment','top', 'Rotation',90, 'Fontsize', 8);
y_labels = text(-0.05*length(x_vals)*ones(1,length(x_vals(1:2:end))),x_vals(1:2:end)-1.5,parcellation_list(selected_list(1:2:end)),'Parent',evalin('base','zef.h_axes1'));
set(y_labels,'HorizontalAlignment','right','VerticalAlignment','top', 'Rotation',0, 'Fontsize', 8);
hold(evalin('base','zef.h_axes1'),'off');
y_labels = text(-0.00*length(x_vals)*ones(1,length(x_vals(2:2:end))),x_vals(2:2:end)-1.5,parcellation_list(selected_list(2:2:end)),'Parent',evalin('base','zef.h_axes1'));
set(y_labels,'HorizontalAlignment','right','VerticalAlignment','top', 'Rotation',0, 'Fontsize', 8);
