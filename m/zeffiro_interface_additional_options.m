...
zef.h_brain_transparency.Value = num2str(1 - zef.brain_transparency);
zef.h_layer_transparency.Value = num2str(1 - zef.layer_transparency);
...
zef.h_inv_colormap.Value = zef.inv_colormap;
...
zef.h_inv_scale.Value = zef.inv_scale;
