...
zef.h_zeffiro.Units = zef.h_zeffiro_window_main.Units;
zef_set_size_change_function(zef.h_zeffiro,1);
if zef.h_segmentation_tool_toggle == 1
    
zef.h_zeffiro.Position = [zef.h_zeffiro_window_main.Position(1) + 0.505*zef.h_zeffiro_window_main.Position(3), ...
                          zef.h_zeffiro_window_main.Position(2),...
                          0.75*0.505*zef.h_zeffiro_window_main.Position(3),...
                          0.75*zef.h_zeffiro_window_main.Position(4)];
                          
else

zef.h_zeffiro.Position = [zef.h_zeffiro_window_main.Position(1) + zef.h_zeffiro_window_main.Position(3), ...
                          zef.h_zeffiro_window_main.Position(2),...
                          0.75*zef.h_zeffiro_window_main.Position(3),...
                          0.6*zef.h_zeffiro_window_main.Position(4)]; 
