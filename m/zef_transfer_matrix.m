function [T, Aux_mat, A] = zef_transfer_matrix(A, B, C, N, L, electrode_model, permutation, precond, impedance_vec, impedance_inf, tol_val, m_max)
...
% gradients (PCG) iteration.
    ...
    % Initialize transfer matrix T and Aux_mat
