...
if not(zef.show_contour_text)
    h_text = [];
end

n_iter = zef.contour_n_smoothing;
line_width = zef.contour_line_width;
...
c_map = eval([colormap_cell{zef.inv_colormap} '(' num2str(colortune_param) ',' num2str(colormap_size) ')']);
