...
set(zef.h_menu_mesh_visualization_tool               ,'MenuSelectedFcn','zef_mesh_visualization_tool;zef_update;');
...
zef.h_zeffiro_window_main.Position = 0.9*zef.h_zeffiro_window_main.Position; 
zef.h_zeffiro_window_main.Position(4) = 1.2*zef.h_zeffiro_window_main.Position(4);
