function fs2zef(segmentation_output_folder, recon_all_output_folder, recon_all_input_files)
%
% fs2zef
%
...
%
%   NOTE: If recon-all IS invoked via the argument recon_all_input_files, this
...
%
% - recon_all_input_files (:,1) string = string([])
%
...
%
    ...
    recon_all_input_files = arrayfun ( @fullfile, recon_all_input_files ) ;
    ...
    if not ( isempty ( recon_all_input_files ) )

        disp(newline + "Attempting to run recon-all on " + recon_all_input_files + "…");
        ...
        for fpath = recon_all_input_files
            ...
            if ( endsWith ( fpath, ".nii" ) || endsWith ( fpath, ".nii.gz" ) ) && numel ( recon_all_input_files ) == 1
            ...
            elseif endsWith ( fpath, FSF_OUTPUT_FORMAT )
                ...
                if contains ( fpath, ".nii" ) && numel ( recon_all_input_files ) == 1
    ...
    mri2mesh.save_color_tables(recon_all_output_folder, segmentation_output_folder);
    ...
    mri2mesh.save_dats(segmentation_output_folder);
    ...
    electrode_file = fullfile(parent_folder, "electrodes.dat");
    ...
    import_script_file = fullfile(parent_folder, "import_segmentation.zef");
...
%
    ...
    env_vars = mri2mesh.FREESURFER_ENV_VARS() ;
